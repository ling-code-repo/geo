...
steps = [
        ...
        {
            "type": "navigate",
            "selector": "https://zhuanlan.zhihu.com/write",
            "timeout": 3000,
            "descript": "正在打开主页"
        },
        ...
        {
            "type": "click",
            "selector": '//button[@class="Button Modal-closeButton Button--plain"]',
            "is_exist": 1,
            "descript": "存在弹窗则关闭",
            "timeout": 3000
        },
        ...
        # 6. 上传图片（变量 files 将在外部替换为图片路径列表）
        {
            "type": "input_files",
            "selector": "input.UploadPicture-input",
            "value": "files",
            "descript": "上传图片"
        },
        ...
        # 7. 处理 AI 声明（分支逻辑）
        {
            ...
            "is_value": "ai_status",
            "is_list": [
                # 如果 ai_status 为真，点击“包含 AI 辅助创作”
                {
                    "type": "click",
                    "selector": '//span[text()="无声明"]',
                    "descript": "ai声明"
                },
                {
                    "type": "click",
                    "selector": '//button[text()="包含 AI 辅助创作"]',
                    "descript": ""
                }
            ],
            "else_list": []  # 否则不执行任何操作
