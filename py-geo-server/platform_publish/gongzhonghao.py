...
steps = [
        {
            "type": "fill",
            "selector": 'textarea[placeholder="请在这里输入标题"]',
            "descript": "输入标题",
            "value": "title",
        },
        {
        ...
        {
            "type": "press",
            "selector": '//div[text()="从这里开始写正文"]',
            "nth": 1,
            "force": 1,
            "descript": "输入正文",
            "value": "content",
        },
        {"type": "click", "selector": '//div[@class="select-cover__btn js_cover_btn_area select-cover__mask"]', "descript": ""},
        {
            "type": "click",
        ...
        {"type": "click", "selector": '//button[text()="下一步"]', "descript": "确认图片"},
        {"type": "click", "selector": '//button[text()="确认"]', "descript": "确认图片"},
        {
            "type": "click",
    ...
    {
        "type": "click",
        "selector": "div.weui-desktop-dialog i.weui-desktop-icon-radio",
        "nth": 2,
        "descript": "",
    },
        # {
        #     "type": "branch",
        #     "is_value": "is_yuanchuang",
        #     "is_list": [
        #         {
        #             "type": "fill",
        #             "selector": '//div[@class="weui-desktop-form__controls"]//input[@placeholder="请输入作者"]',
        #             "value": "author",
        #             "descript": "",
        #         },
        #         {"type": "click", "selector": "i.weui-desktop-icon-checkbox", "descript": ""},
        #     ],
        #     "else_list": [
        #         {
        #             "type": "click",
        ...
        #     ],
        # },
        {"type": "click", "selector": '//div[@class="weui-desktop-dialog"]//button[text()="确定"]', "descript": "确定"},
        {"type": "click", "selector": '//span[text()="发表"]', "descript": "发表"},
        {
            "type": "click",
            "selector": '//button[text()="无需声明并发表"]',
            "descript": "发布成功",
            "is_exist": 1,
            "timeout": 4000,
        },
        ...
        #         {
        #             "type": "click",
        #             "selector": '//div[@class="mass-send__td"]//div[@class="weui-desktop-switch__box"]',
        #             "is_try": 1,
        #             "is_exist": 1,
        #             "descript": "设置定时发表",
        #             "timeout": 4000,
        ...
        #         {
        #             "type": "click",
        #             "selector": '//dt[@class="weui-desktop-form__dropdown__dt weui-desktop-form__dropdown__inner-button"]',
        #             "descript": "",
        #             "is_wait": 2,
        #         },
        #         {"type": "wxgzh-timmer", "selector": ""},
        ...
        {
            "type": "click",
            "selector": '//button[text()="继续发表"]',
            "descript": "发布成功",
            "is_exist": 1,
            "timeout": 4000,
        },
    ]
async def wxgzh(page:Page):
    ...
    await page.locator('//a[text()="登录"]').click()
    time.sleep(2)
    try:
        await page.wait_for_selector('div.weui-desktop_name', timeout=60000)
    except  Exception as e:
        raise
        # await logout_fun(platform, page, udid, uid, juzhen_user_id)
    random_wait_time = random.randint(1, 2)
    await asyncio.sleep(random_wait_time)
    await page.locator('//span[text()="内容管理"]').click()
    await page.locator('//span[text()="草稿箱"]').click()
    random_wait_time = random.randint(1, 2)
    await asyncio.sleep(random_wait_time)
    await page.locator('//i[@class="weui-desktop-card__icon-add"]').hover()
    random_wait_time = random.randint(1, 2)
    await asyncio.sleep(random_wait_time)
    async with page.context.expect_page() as new_page_info:
        await page.locator('//i[@class="icon-svg-editor-appmsg"]').click()
    new_page = await new_page_info.value
    return new_page

class Gongzhonghao(Publish):
