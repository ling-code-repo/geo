package com.qianyu.framework.websocket.config;

import com.qianyu.framework.mq.redis.config.YudaoRedisMQConsumerAutoConfiguration;
import com.qianyu.framework.mq.redis.core.RedisMQTemplate;
import com.qianyu.framework.websocket.core.handler.JsonWebSocketMessageHandler;
import com.qianyu.framework.websocket.core.listener.WebSocketMessageListener;
import com.qianyu.framework.websocket.core.security.LoginUserHandshakeInterceptor;
import com.qianyu.framework.websocket.core.security.WebSocketAuthorizeRequestsCustomizer;
import com.qianyu.framework.websocket.core.sender.kafka.KafkaWebSocketMessageConsumer;
import com.qianyu.framework.websocket.core.sender.kafka.KafkaWebSocketMessageSender;
import com.qianyu.framework.websocket.core.sender.local.LocalWebSocketMessageSender;
import com.qianyu.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageConsumer;
import com.qianyu.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageSender;
import com.qianyu.framework.websocket.core.sender.redis.RedisWebSocketMessageConsumer;
import com.qianyu.framework.websocket.core.sender.redis.RedisWebSocketMessageSender;
import com.qianyu.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageConsumer;
import com.qianyu.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageSender;
import com.qianyu.framework.websocket.core.session.WebSocketSessionHandlerDecorator;
import com.qianyu.framework.websocket.core.session.WebSocketSessionManager;
import com.qianyu.framework.websocket.core.session.WebSocketSessionManagerImpl;
