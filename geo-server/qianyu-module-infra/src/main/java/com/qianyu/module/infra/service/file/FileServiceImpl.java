...
import com.qianyu.module.infra.controller.admin.file.vo.file.FilePresignedUrlRespVO;
...
import com.qianyu.module.infra.framework.file.core.utils.FileTypeUtils;
...
public class FileServiceImpl implements FileService {
    ...
    @Override
    @SneakyThrows
    public FileDO createFile0(byte[] content, String name, String directory, String type) {
        // 1.1 处理 type 为空的情况
    ...
    @Override
    @SneakyThrows
    public void deleteFileList(Collection<Long> ids) {
        // 删除文件
