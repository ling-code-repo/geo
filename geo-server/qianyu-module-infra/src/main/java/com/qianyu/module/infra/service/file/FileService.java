...
public interface FileService {
    ...
    default String createFile(@NotEmpty(message = "文件内容不能为空") byte[] content,
        ...
        return createFile0(content, name, directory, type).getUrl();
    }
     ...
     * @return 文件路径
     */
    FileDO createFile0(@NotEmpty(message = "文件内容不能为空") byte[] content,
                       String name, String directory, String type);
     ...
     * @param ids 编号列表
     */
    void deleteFileList(Collection<Long> ids) throws Exception;
