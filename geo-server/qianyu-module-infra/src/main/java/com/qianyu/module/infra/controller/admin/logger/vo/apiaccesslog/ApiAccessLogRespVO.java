package com.qianyu.module.infra.controller.admin.logger.vo.apiaccesslog;

import com.qianyu.framework.excel.core.annotations.DictFormat;
import com.qianyu.framework.excel.core.convert.DictConvert;
import com.qianyu.module.infra.enums.DictTypeConstants;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(com.qianyu.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
    ...
    @Schema(description = "结果提示", example = "qianyu，牛逼！")
    @ExcelProperty("结果提示")
