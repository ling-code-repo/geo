package com.qianyu.module.infra.service.codegen.inner;
...
import com.qianyu.framework.apilog.core.enums.OperateTypeEnum;
import com.qianyu.framework.common.exception.util.ServiceExceptionUtil;
...
import com.qianyu.framework.common.util.date.LocalDateTimeUtils;
import com.qianyu.framework.common.util.object.BeanUtils;
import com.qianyu.framework.common.util.object.ObjectUtils;
import com.qianyu.framework.common.util.string.StrUtils;
...
import com.qianyu.module.infra.enums.codegen.CodegenFrontTypeEnum;
...
import com.qianyu.module.infra.enums.codegen.CodegenVOTypeEnum;
...
public class CodegenEngine {
    ...
    public CodegenEngine() {
        ...
        this.cloudEnable = ClassUtils.isPresent("com.qianyu.module.infra.framework.rpc.config.RpcConfiguration",
