...
import com.qianyu.module.system.controller.admin.permission.vo.menu.MenuSaveVO;
import com.qianyu.module.system.dal.dataobject.permission.MenuDO;
import com.qianyu.module.system.dal.mysql.permission.MenuMapper;
import com.qianyu.module.system.dal.redis.RedisKeyConstants;
import com.qianyu.module.system.enums.permission.MenuTypeEnum;
...
import static com.qianyu.module.system.dal.dataobject.permission.MenuDO.ID_ROOT;
...
//        Map<Long,Boolean> existMap = Maps.newHashMap();
        LinkedList<Long> ids =  new LinkedList<Long>();
        ids.add(id);
        while (!ids.isEmpty()) {
            Long theId = ids.pop();
            idSet.add(theId);
            ids.addAll(menuMapper.selectIdListByParentId(theId));
//            if (!existMap.containsKey(theId)) {
//                existMap.put(theId, true);
//
//            }
        }
        // 标记删除
        menuMapper.deleteByIds(idSet);
        // 删除授予给角色的权限
        permissionService.deleteListByMenuIds(idSet);
    }
