package com.qianyu.module.system.service.permission;
...
import com.qianyu.framework.common.biz.system.permission.dto.DeptDataPermissionRespDTO;
...
import com.qianyu.module.system.dal.dataobject.permission.RoleMenuDO;
import com.qianyu.module.system.dal.dataobject.permission.UserRoleDO;
import com.qianyu.module.system.dal.mysql.permission.RoleMenuMapper;
import com.qianyu.module.system.dal.mysql.permission.UserRoleMapper;
import com.qianyu.module.system.dal.redis.RedisKeyConstants;
import com.qianyu.module.system.enums.permission.DataScopeEnum;
...
public class PermissionServiceImpl implements PermissionService {
    ...
    @Override
//    @CacheEvict(value = RedisKeyConstants.MENU_ROLE_ID_LIST, key = "#menuId")
    public void deleteListByMenuIds(Collection<Long> menuIds) {
        roleMenuMapper.deleteListByMenuIds(menuIds);
    }
    ...
    @Override
    public void doAssignUserRole(Long userId, Set<Long> roleIds) {
        // 获得角色拥有角色编号
