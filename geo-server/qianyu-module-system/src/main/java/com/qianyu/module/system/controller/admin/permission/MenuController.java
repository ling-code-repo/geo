package com.qianyu.module.system.controller.admin.permission;
...
import com.qianyu.module.system.controller.admin.permission.vo.menu.MenuRespVO;
import com.qianyu.module.system.controller.admin.permission.vo.menu.MenuSaveVO;
import com.qianyu.module.system.controller.admin.permission.vo.menu.MenuSimpleRespVO;
...
public class MenuController {
    ...
    @DeleteMapping("/deleteMenuCascade")
    @Operation(summary = "删除菜单")
    @Parameter(name = "id", description = "菜单编号", required= true, example = "1024")
    @PreAuthorize("@ss.hasPermission('system:menu:delete')")
    public CommonResult<Boolean> deleteMenuCascade(@RequestParam("id") Long id) {
        menuService.deleteMenuCascade(id);
        return success(true);
    }
