  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="收录状态" prop="status">
        ...
        >
          <el-option
            v-for="dict in getIntDictOptions(DICT_TYPE.GEO_INCLUDE_STATUS)"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
...
<!--      <el-table-column label="问题id" align="center" prop="id" />-->
      ...
      <el-table-column label="收录状态" align="center" prop="status">
        <template #default="scope">
          <dict-tag :type="DICT_TYPE.GEO_INCLUDE_STATUS" :value="scope.row.status" />
        </template>
      </el-table-column>
      <el-table-column
        label="创建时间"
...
const handleRowCheckboxChange = (records: Question[]) => {
