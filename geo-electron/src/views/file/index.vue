  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item>
        ...
        <el-button type="primary" plain @click="openForm">上传文件
        </el-button>
        <el-button
          type="danger"
          plain
...
const GEO_PICTURE = 'GEO_PICTURE'

defineOptions({ name: 'GeoFile' })
...
const getList = async () => {
  loading.value = true
  try {
    queryParams['category'] = GEO_PICTURE
...
const formRef = ref()
const openForm = () => {
  formRef.value.open(GEO_PICTURE)
}
...
const handleDelete = async (id: number) => {
  try {
    ...
    // 发起删除
    await FileApi.deleteFileList([id])
